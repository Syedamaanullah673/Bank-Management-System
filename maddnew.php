...
{
  if (!$con->query("insert into useraccounts (name,AadhaarNumber,accountNo,accountType,city,address,email,password,balance,source,number,branch) values ('$_POST[name]','$_POST[AadhaarNumber]','$_POST[accountNo]','$_POST[accountType]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]','$_POST[balance]','$_POST[source]','$_POST[number]','$_POST[branch]')")) {
    ...
    <table class="table">
      <tbody>
        <tr>
          ...
          <td><input type="number" name="AadhaarNumber" class="form-control input-sm" required></td>
        </tr>
        <tr>
